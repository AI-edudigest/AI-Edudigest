...
const RightSidebar: React.FC<RightSidebarProps> = ({ onResourceClick, onMagazineClick }) => {
  ...
  return (
    <aside className="relative w-full h-full bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 transition-colors duration-200 shadow-lg flex flex-col">
      <div className="flex-1 overflow-y-auto px-6 pt-12 pb-8 space-y-6">
        ...
        {!hasSearchResults && duplicatedNews.length > 0 && (
          <div 
          ...
          >
            ...
            <div className="relative">
              <div 
                ...
                className="overflow-hidden rounded-lg bg-gray-900/40"
              ...
              <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-gray-900 to-transparent dark:from-gray-900/95 pointer-events-none" />
            </div>
          </div>
        )}
